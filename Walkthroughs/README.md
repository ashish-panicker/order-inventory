...
This folder contains step-by-step guides (walkthroughs) designed to help learners and new developers incrementally add essential tools and patterns to their Spring Boot microservices.

## Available Walkthroughs

1. **[Spring Boot Profiles](1_spring_boot_profiles.md)**: Learn how to split configuration files and load different profiles (`dev`, `qa`, `prod`) simultaneously.
